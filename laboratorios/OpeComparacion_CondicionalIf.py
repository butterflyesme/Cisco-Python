...
Imagina que tu programa de computadora ama estas plantas. Cada vez que recibe una entrada en forma 
de la palabra Espatifilo, grita involuntariamente a la consola la siguiente cadena:  "¡Espatifilo 
...
si la cadena ingresada es "Espatifilo".
Imprima "No, ¡quiero un gran Espatifilo!" si la cadena ingresada es "espatifilo".
Imprima  "¡Espatifilo! ¡No [entrada]!"  de lo contrario. Nota: [entrada] es la cadena que se toma 
como entrada.
...
"""
print("Hola, que tal, sea bienvenido al Huerto Maximus")
planta = input("Que planta quiere comprar? ")
