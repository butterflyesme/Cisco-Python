...
Desde la introducción del calendario gregoriano (en 1582), se utiliza la siguiente regla para determinar 
el tipo de año:
...
if año < 1582: 
   print(f"{año} no entra dentro del calendario gregoriano")
else: 
    if año % 4 != 0: 
        print(f"{año} es un año común")
    elif año % 100 != 0: 
