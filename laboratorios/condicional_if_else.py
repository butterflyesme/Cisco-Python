...
denominado Impuesto Personal de Ingresos (IPI, para abreviar) tenía que pagarse una vez al año y se 
evaluó utilizando la siguiente regla:
...
Si el ingreso era superior a esta cantidad, el impuesto era igual a 14,839 pesos y 2 centavos, más 
el 32% del excedente sobre 85,528 pesos.
...
Resultado esperado: El impuesto es: 0.0 pesos
"""
#IPI : Impuesto Personal de Ingreso 
ingreso = float(input("¿Cual es tu ingreso anual? "))
if ingreso < 85528: 
...
print(f"Total a pagar del impuesto anual es de {impuesto} pesos")
