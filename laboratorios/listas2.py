...
Algunas personas los consideran el acto más influyente de la era del rock. De hecho, se incluyeron en la compilación 
...
# paso 3
for i in range(2):
    miembros = input("Agregar un miembro de la banda: ")
