...
la lista actual.
No hemos proporcionado datos de prueba, ya que sería demasiado fácil. Puedes usar nuestro esqueleto en 
su lugar.
"""
miLista = [1, 2, 4, 4, 1, 4, 2, 6, 2, 9]
listaAnalizar = []
for i in miLista: 
    if i not in listaAnalizar: 
        listaAnalizar.append(i)
miLista = listaAnalizar[:]
